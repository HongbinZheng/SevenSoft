    ...
    return (
      ...
      >
          ...
          return (
            ...
            >
              <div className="row" style={{ marginTop: "30px" }}>
                ...
                <div className="col">
                  <h3>{item.quantityInCart}</h3>
                </div>
                <div className="col">
                  <h3 className="card-text">
                    $
                    {(item.price * item.discount * item.quantityInCart).toFixed(
                      2
                    )}
                  </h3>
                </div>
        ...
        <div className="col" style={{ marginTop: "50px" }}>
          <h2 className="card-text text-right">
            Subtotal: ${this.getTotalPrice(this.state.cartItems).toFixed(2)}
          </h2>
          <button
            className="check out button"
            onClick={() => this.handleCheckOut(this.state.cartItems)}
          >
            {" "}
