              ...
              <div className = "CartDiv" style = {{position:'absolute', right:'45px', top:'100px', fontFamily:'Lucida Handwriting'}}>
                ...
                {/* <div className="Cart card shadow rounded float-right " style={{position:"relative", border:"1px solid #000000", right:"10px", top: "10px"}}> */}
                    ...
                    <h2 className="card-text text-left" style={{marginLeft:10,fontFamily:'Lucida Handwriting'}} >Total: <div className="text-right" style={{marginRight:10,fontFamily:'Lucida Handwriting'}}>${this.getTotalPrice(this.state.cartItems).toFixed(2)}</div></h2>
                        <button className="btn btn-info"  style={{textAlign:"center",fontSize:30, marginLeft: '12%', marginBottom:'10px', marginTop:'10px', fontFamily:'Lucida Handwriting'}} onClick={()=>this.handleCheckoutClick(this.state.cartItems)}><i className="fas fa-cart-arrow-down fa-1x"></i> CheckOut </button>
                    </div>
            </div>
            </div> : null
           // </div>
