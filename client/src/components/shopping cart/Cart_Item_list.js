    ...
    render() {
        return (
            ...
            <li className="list-group-item CartItem">
                <h3 className="card-title text-left" style= {{width:"200px"}}><strong>{this.props.item.name}  <i className="fas fa-trash-alt" onClick={()=>this.props.handleRemove(this.props.item.itemid)} /></strong></h3>
